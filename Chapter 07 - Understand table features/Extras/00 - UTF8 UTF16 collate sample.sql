...
SELECT @nBaseString
    ...
    , @BaseString COLLATE Latin1_General_100_CI_AS_SC_UTF8
    , DATALENGTH(@BaseString COLLATE Latin1_General_100_CI_AS_SC_UTF8) 'UTF-8'
...
SELECT @nBaseString
    ...
    , DATALENGTH(@UTF16string) 'UTF-16'
    , DATALENGTH(@vBaseString COLLATE Latin1_General_CI_AS) 'Latin (v)'
    , @vBaseString COLLATE Latin1_General_100_CI_AS_SC_UTF8 'UTF-8 value'
    , DATALENGTH(@vBaseString COLLATE Latin1_General_100_CI_AS_SC_UTF8) 'UTF-8 length'
    , DATALENGTH(@vUTF16String) 'UTF-16 (v)';
...
SELECT @nvBaseString
    ...
    , CAST(@nvBaseString COLLATE Latin1_General_CI_AS AS VARCHAR(8))
    , DATALENGTH(CAST(@nvBaseString COLLATE Latin1_General_CI_AS AS VARCHAR(8))) 'Latin (v)'
    -- In UTF-8, this requires 7 bytes to store, which is only 1 less than UTF-16, which is perhaps more bytes than you expected
    , CAST(@nvBaseString COLLATE Latin1_General_100_CI_AS_SC_UTF8 AS VARCHAR(8))
    , DATALENGTH(CAST(@nvBaseString COLLATE Latin1_General_100_CI_AS_SC_UTF8 AS VARCHAR(8))) 'UTF-8 (v)'
    , DATALENGTH(@vUTF16String) 'UTF-16 (v)';
...
BEGIN
    ...
    SELECT @Original
        , @Original COLLATE Latin1_General_100_CI_AS_SC_UTF8;
END
...
ALTER DATABASE Utf8ConversionTest COLLATE Latin1_General_100_CS_AS_SC_UTF8;
